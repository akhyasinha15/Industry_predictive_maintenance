...
print("\nStep 2: Preparing data for One-Class SVM (training on normal data only)...")
...
print("\nStep 4: Building and training the One-Class SVM model...")
model_pipeline = Pipeline(steps=[('preprocessor', preprocessor),
                                 ('classifier', OneClassSVM(kernel='rbf', nu=0.0339))])
